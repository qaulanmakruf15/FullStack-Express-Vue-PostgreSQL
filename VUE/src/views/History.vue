...
export default {
  ...
  methods: {
    ...
    today_incomes() {
      axios
        .get('http://127.0.0.1:3000/order/today_income')
        .then((response) => {
    ...
    orders() {
      axios
        .get('http://127.0.0.1:3000/order/total_order')
        .then((response) => {
    ...
    years_income() {
      axios
        .get('http://127.0.0.1:3000/order/total_yearIncome')
        .then((response) => {
    ...
    thisMonth() {
      axios
        .get('http://127.0.0.1:3000/order/this_month')
        .then((response) => {
    ...
    lastMonth() {
      axios
        .get('http://127.0.0.1:3000/order/last_month')
        .then((response) => {
          // this.card_yearIncome = response.data.data[0].subtotals
